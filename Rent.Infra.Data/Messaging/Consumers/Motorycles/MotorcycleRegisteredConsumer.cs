...
{
    public class MotorcycleRegisteredConsumer : EventConsumerBase
    {
        public MotorcycleRegisteredConsumer(IModel channel, IServiceScopeFactory scopeFactory, ILogger logger, string nameEvent)
        ...
        public override void StartConsuming()
        {
            ...
            consumer.Received += (sender, e) =>
            {
                Task.Run(async () =>
                {
                    await MotorycleRegisteredEvent(e);
                });
            };
        ...
        private async Task MotorycleRegisteredEvent(BasicDeliverEventArgs e)
        {
